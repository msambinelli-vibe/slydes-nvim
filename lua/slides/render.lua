...
local highlight_links = {
  ...
  SlyContainerHead = "CursorLine",
  SlyContainerBody = "NormalFloat",
  SlyTheorem = "DiagnosticInfo",
  SlyTheoremHead = "CursorLine",
  SlyTheoremBody = "NormalFloat",
  SlyLemma = "DiagnosticHint",
  SlyLemmaHead = "CursorLine",
  SlyLemmaBody = "NormalFloat",
  SlyProof = "Comment",
  SlyProofHead = "CursorLine",
  SlyProofBody = "NormalFloat",
  SlyCodeHead = "CursorLine",
  SlyFigure = "Special",
  SlyColumns = "Type",
}
